...
const PROFILES = {
  ...
  b_eternal: {
    ...
    tag: '高迴避型依附',
    emoji: '🌌',
    videoSrc: '/src/animations/The Eternal Observer.mp4',
    accentColor: '#7B9BB5',
...
這不是你的錯，也不是他們的無能。你們面對的是一個長期被迴避型依附系統鎖住的神經迴路。理解這一點，能讓雙方從「誰該被怪罪」的循環中解脫，開始真正的靠近。`,
  ...
  secure: {
    ...
    tag: '安全型依附',
    emoji: '☕',
    videoSrc: '/src/animations/The Warm Island.mp4',
    accentColor: '#6B7CB5',
...
你的挑戰在於：你的穩定有時可能讓伴侶不知道如何「回報」你。確保你也清楚表達你的需求，讓關係成為雙向的滋養，而不只是你單方向地給予。`,
  ...
  a_timeless: {
    ...
    tag: '焦慮型依附',
    emoji: '⏰',
    videoSrc: '/src/animations/The Timeless Anxious.mp4',
    accentColor: '#9B7EA6',
...
最重要的一步，是讓伴侶了解你的觸發點——不是控訴他做錯了什麼，而是透明地說：「當你這樣做的時候，我會啟動這種感覺，這是我的模式，不是你的問題。」這種共識能讓你們一起成為彼此情緒的翻譯者。`,
  ...
  da_drowning: {
    ...
    tag: '凍結型應激',
    emoji: '🎵',
    videoSrc: '/src/animations/The Drowning Echo.mp4',
    accentColor: '#6080A8',
...
最有效的工具是事先協議一個「暫停信號」：在冷靜時告訴伴侶：「當我變得沉默，我不是在放棄這段對話，我只是需要20分鐘讓神經系統降溫。20分鐘後，我會回來。」`,
  ...
  ca_masked: {
    ...
    tag: '討好型依附',
    emoji: '🎭',
    videoSrc: '/src/animations/The Masked Martyr.mp4',
    accentColor: '#C896A8',
...
一段健康的關係需要雙向的需求與滿足。當你永遠在付出而不索取，你的伴侶其實失去了「照顧你」的機會，這會讓關係的重心長期失衡。允許對方也來照顧你，是你給這段關係最好的禮物之一。`,
  ...
  db_scholar: {
    ...
    tag: '理智化防禦',
    emoji: '📚',
    videoSrc: '/src/animations/The Exiled Scholar.mp4',
    accentColor: '#8A7A9E',
...
最重要的一步：下次伴侶表達情緒時，先放下分析，試著說：「我聽到了，你現在一定很難受。」只是這一句，比任何分析都更有力量。`,
  ...
  ab_wilderness: {
    ...
    tag: '混亂型依附',
    emoji: '📼',
    videoSrc: '/src/animations/The Wilderness Looper.mp4',
    accentColor: '#A07098',
...
最重要的對話是：在關係平靜時，讓伴侶了解你的模式——「當我突然退縮，不是因為我不愛你，而是我的某個部分被嚇到了。我需要你不要追，等我回來。」這個協議能為你們節省大量的焦慮和誤解。`,
  ...
  d_static: {
    ...
    tag: '解離型應激',
    emoji: '📺',
    videoSrc: '/src/animations/The Static Prophet.mp4',
    accentColor: '#6070A8',
...
最有效的方式是讓伴侶了解你的解離模式——它是什麼感覺、什麼情況下會發生——並共同設計一個「喚回儀式」：一個輕柔的觸碰、一個名字、一個問題，讓你知道他在等你回來。`,
  ...
  ac_candlelit: {
    ...
    tag: '融合型依附',
    emoji: '🕯️',
    videoSrc: '/src/animations/The Candlelit Martyr.mp4',
    accentColor: '#C8A070',
...
給自己更多的獨立空間，不只是為了你，也是讓你的伴侶有空間自由地做自己——包括偶爾不快樂，而不需要擔心你。`,
  ...
  c_lonely: {
    ...
    tag: '成就導向依附',
    emoji: '🏃',
    videoSrc: '/src/animations/The Lonely Pacer.mp4',
    accentColor: '#7A6090',
...
試著讓伴侶看見你「沒在表現」的那一面——懶惰的、散漫的、不完美的那一面。讓他有機會選擇愛那個版本的你，而不只是愛那個閃閃發光的你。`,
  ...
  ad_severed: {
    ...
    tag: '追逃型依附',
    emoji: '☎️',
    videoSrc: '/src/animations/The Severed Caller.mp4',
    accentColor: '#5080A0',
...
你們面對的是一個「焦慮-迴避螺旋」：你越追，他越退；他越退，你越追。打破這個螺旋需要雙方同時改變——你練習容忍沉默，他練習主動給予確認。`,
  ...
  dc_snapshot: {
    ...
    tag: '反芻型應激',
    emoji: '📷',
    videoSrc: '/src/animations/The Submerged Snapshot.mp4',
    accentColor: '#8070A8',
